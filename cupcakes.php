...
<head>
    ...
    <title>Talitsi cupcakes shop</title>
    <link rel="stylesheet" href="../css/cupcakeshop.css">
...
<body>
    ...
    <div class="blogsection">
            <div class="prod">
                ...
                <div class="text">
                    <h3>Sweet vanilla cupcakes</h3>
                    <p class="price">KSH.350</p>
                    <p class="contact">contact:0706122345</p>
                </div>
            </div>
            <div class="prod">
                <div class="prod1img">
                ...
                <div class="text">
                    <h3>Chocolate with cherry cupcakes</h3>
                    <p class="price">KSH.800</p>
                    <p class="contact">contact:0706111014</p>
                </div>
            </div>
            <div class="prod">
                <div class="prod1img">
            ...
            <div class="prod">
                ...
                <div class="text">
                    <h3>Plain Chocolate cupcakes</h3>
