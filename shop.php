...
<head>
    ...
    <title>Talitsi Shop</title>
    <link rel="stylesheet" href="../css/usershop.css">
</head>
<body>
    <div class="toppage">
        <div class="businessname">
            <h2>Talitsi cakes Shop</h2>
        </div>
        <div class="navbar">
            <ul>
                ...
                <li><img src="../images/user.png"><h2><?= $_SESSION['loggedin_user']['fname']?></h2></li>&nbsp&nbsp&nbsp
                <li>
    ...
    <h2>Welcome <?= $_SESSION['loggedin_user']['fname']  ?>,</h2>

    <h2 class="shopbody">What we offer</h2>
    <div class="shopgallery">
        <div class="desserts">
            <span><img src="../images/chocodessert.jpg"></span>
            <h3>Desserts</h3>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
            <a href="desserts.php">Explore More</a>

        </div>
        
        <div class="birthday">
            <span class="img"><img src="../images/birthday.jpg" alt=""></span>
            <h3>Birthday Cakes</h3>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
            <a href="birthday.php">Explore More</a>

        </div>
        <div class="cupcakes">
            <span class="img"><img src="../images/cupcake2.jpg" alt=""></span>
            <h3>Cupcakes</h3>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
            <a href="cupcakes.php">Explore More</a>
